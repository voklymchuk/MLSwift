#
#  Be sure to run `pod spec lint MLSwift.podspec' to ensure this is a
...
as a feature extractor that is part of a custom model
  ...
  spec.author             = { "Valerii Klymchuk" => "voklymchuk@gmail.com" }
  # Or just: spec.author    = "Valerii Klymchuk"
  # spec.authors            = { "Valerii Klymchuk" => "voklymchuk@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Valerii Klymchuk"
  ...
  spec.source       = { :git => "https://github.com/voklymchuk/MLSwift.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "MLSwift/**/*.{h,m,swift}"
